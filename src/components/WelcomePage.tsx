...
export const WelcomePage = ({ onEnterPortfolio }: WelcomePageProps) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center gradient-subtle relative overflow-hidden">
      ...
      <div className="absolute top-40 left-1/4 animate-float">
        <Code className="h-8 w-8 text-primary/20" style={{animationDelay: '1s'}} />
      </div>
      <div className="absolute top-60 right-1/4 animate-float">
        <Briefcase className="h-8 w-8 text-accent/20" style={{animationDelay: '2s'}} />
      </div>
      <div className="absolute bottom-40 left-1/3 animate-float">
        <Sparkles className="h-8 w-8 text-primary/20" style={{animationDelay: '0.5s'}} />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <h1 className={`text-5xl md:text-7xl font-bold leading-tight transition-all duration-1000 ${
          ...
          {/* Subtitle */}
          <p className={`text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto transition-all duration-1000 delay-500 ${
            animationComplete ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
          ...
          <div className={`flex flex-wrap justify-center gap-4 text-sm transition-all duration-1000 delay-700 ${
            ...
            <span className="px-4 py-2 bg-primary/10 text-primary rounded-full">SIH 2024 Grand Finalist</span>
            <span className="px-4 py-2 bg-accent/10 text-accent-foreground rounded-full">Cloud Computing Certified</span>
            <span className="px-4 py-2 bg-secondary/50 text-secondary-foreground rounded-full">Full Stack Expert</span>
          </div>
          ...
          <div className={`transition-all duration-1000 delay-1000 ${
            ...
            <Button
              ...
              className="gradient-primary shadow-elegant transition-smooth hover:scale-105 animate-glow text-lg px-8 py-6 group"
            >
              Enter Portfolio
